...
local FILES={{remote="corner.lua",path="/corner.lua"},{remote="corner-startup.lua",path="/startup.lua"}}
...
local base="https://raw.githubusercontent.com/"..REPOSITORY.."/"..sha.."/airship/"
