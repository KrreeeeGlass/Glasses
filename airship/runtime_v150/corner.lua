...
local nextGps=0
while true do
  if os.clock()>=nextGps then
    local x,y,z=gps.locate(0.20,false)
    if x then gpsPosition={x=x,y=y,z=z,at=os.epoch("utc")} end
    nextGps=os.clock()+0.20
  end
