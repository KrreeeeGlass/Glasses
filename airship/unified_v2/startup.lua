...
local ROLE_MARKER="UNIFIED_AIRSHIP_V2_STARTUP"
local REPOSITORY="KrreeeeGlass/Glasses"
local LOCAL="/airship.lua"
local REMOTE="airship/unified_v2/airship.lua"
...
local function updateLauncher()
  ...
  if not source:find('ROLE_MARKER="UNIFIED_AIRSHIP_V2_LAUNCHER"',1,true) or
...
print("[unified-v2] UNIVERSAL AIRSHIP startup")
