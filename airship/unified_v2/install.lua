...
local INSTALLER_ROLE="UNIFIED_AIRSHIP_V2_INSTALLER"
local REPOSITORY="KrreeeeGlass/Glasses"
local FILES={
  {remote="airship.lua",path="/airship.lua",marker='ROLE_MARKER="UNIFIED_AIRSHIP_V2_LAUNCHER"'},
  {remote="startup.lua",path="/startup.lua",marker='ROLE_MARKER="UNIFIED_AIRSHIP_V2_STARTUP"'},
}
if not http then error("HTTP is disabled in the CC:Tweaked server config",0) end
local base="https://raw.githubusercontent.com/"..REPOSITORY.."/main/airship/unified_v2/"
