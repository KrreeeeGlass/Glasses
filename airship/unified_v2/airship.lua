...
local ROLE_MARKER="UNIFIED_AIRSHIP_V2_LAUNCHER"
...
if count==0 then
  ...
  remote="airship/runtime_v140/center.lua"
  cache="/airship_center_runtime_v140.lua"
  marker='ROLE_MARKER="CENTER_CONTROLLER_MAIN"'
elseif count==3 then
  role="CORNER RELAY"
  remote="airship/runtime_v140/corner.lua"
  cache="/airship_corner_runtime_v140.lua"
