...
local ROLE_MARKER="UNIFIED_AIRSHIP_LAUNCHER"
...
if count==0 then
  ...
  remote="airship/center/main.lua"
  cache="/airship_center_runtime.lua"
  marker='ROLE_MARKER="CENTER_CONTROLLER_MAIN"'
elseif count==3 then
  role="CORNER RELAY"
  remote="airship/corner/main.lua"
  cache="/airship_corner_runtime.lua"
